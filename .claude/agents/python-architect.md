...
## Purpose
Provides architectural guidance and ensures code quality standards for the csm-set Cross-Sectional Momentum project.
...
- Works with `@git-commit-reviewer` for commit quality
