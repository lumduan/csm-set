...
Ensures comprehensive documentation standards and maintains consistency across the csm-set Cross-Sectional Momentum project.
...
- Works with `@git-commit-reviewer` for documentation commits
