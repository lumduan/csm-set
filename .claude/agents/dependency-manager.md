...
## Purpose
Manages Python dependencies and execution environment for the csm-set Cross-Sectional Momentum project using uv package manager.
...
- Works with `@git-commit-reviewer` for dependency change commits
