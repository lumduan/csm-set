...
_`pnl.csv` was extended to **2026-08-17** on 2026-08-17 (adding the 08-17 row), so it now
runs **70 rows, 2026-05-05 → 2026-08-17**, and **`pnl_realized_unrealized.png` was regenerated from it
the same day, so the CSV and the P/L PNG are in sync at 70 points**. Extending the CSV and
regenerating the chart in the same session is the established practice — it is what kept the
CSV-leads-the-PNG gap from reaching a commit on both 2026-08-14 and 2026-08-17._
...
At 2026-08-17 (the CSV's last row): realized **−49,091.38** · unrealized **+231,713.35** · total
**+182,621.97** · commission **−3,735.16 THB**. **Only the unrealized leg has moved since 2026-08-03** —
...
with no realisation involved, then recovered across 2026-08-13, 08-14 and 08-17. **Read this line as
...
| `pnl_realized_unrealized.png` *(the 2026-08-17 PNG, through 08-17)* | realized **−49,091.38** · unrealized **+231,713.35** · commission **−3,735.16** THB; the realized line is **flat except at 2026-06-02, 2026-07-01 and 2026-08-03** — **three** steps. *(The superseded 2026-08-14 render showed −49,091.38 / +183,951.35 at 69 points; the 2026-08-12 one −49,091.38 / +129,844.35 at 67 points; the 2026-08-01 one −19,315.93 / +147,665.89 / −3,052.51 and only two steps.)* |
| `pnl.csv` last row *(the CSV and the P/L PNG are in sync — see the header)* | 2026-08-17: realized **−49,091.38** · unrealized **+231,713.35** · total **+182,621.97** · commission **3,735.16** THB; **70 rows**, matching `equity_curve`'s 70 |
| The August regeneration *(**done** 2026-08-12, **superseded** by the 2026-08-14 and then the 2026-08-17 render)* | ✅ satisfied — the current PNG title reads `realized -49,091 · unrealized +231,713 · commission −3,735 THB`, the series ends 2026-08-17 at 70 points, and the realized line steps **three** times. Verified by eye against the rendered image, not only from the generator's stdout |
| Only ONE PNG may change on a P/L regeneration | ✅ `gen_pnl_chart.py:118` writes `pnl_realized_unrealized.png` and nothing else. Checksum the four PNGs before and after: the three NAV charts must be **byte-identical** and keep their 2026-08-01 mtimes. Verified 2026-08-14 and again 2026-08-17 — only the P/L PNG's hash moved on both |
